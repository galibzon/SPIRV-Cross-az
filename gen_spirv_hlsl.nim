...
type CompilerError* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::CompilerError", inheritable.}  = object
type Instruction* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::Instruction", inheritable.}  = object
type IVariant* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::IVariant", inheritable.}  = object
...
type SPIRUndef* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRUndef", inheritable.}  = object
type SPIRCombinedImageSampler* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRCombinedImageSampler", inheritable.}  = object
type SPIRConstantOp* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRConstantOp", inheritable.}  = object
type SPIRType* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRType", inheritable.}  = object
...
type ImageType* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRType::ImageType", inheritable.}  = object
type ImageType00* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRType::ImageType", inheritable.}  = object
type SPIRExtension* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRExtension", inheritable.}  = object
...
type SPIREntryPoint* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIREntryPoint", inheritable.}  = object
type a* {.nodecl, inheritable.}  = object
type a00* {.nodecl, inheritable.}  = object
type SPIRExpression* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRExpression", inheritable.}  = object
type SPIRFunctionPrototype* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRFunctionPrototype", inheritable.}  = object
type SPIRBlock* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRBlock", inheritable.}  = object
...
type Phi* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRBlock::Phi", inheritable.}  = object
type Case* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRBlock::Case", inheritable.}  = object
type SPIRFunction* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRFunction", inheritable.}  = object
type Parameter* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRFunction::Parameter", inheritable.}  = object
type CombinedImageSamplerParameter* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRFunction::CombinedImageSamplerParameter", inheritable.}  = object
type SPIRAccessChain* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRAccessChain", inheritable.}  = object
type SPIRVariable* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRVariable", inheritable.}  = object
type SPIRConstant* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRConstant", inheritable.}  = object
type Constant* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRConstant::Constant", inheritable.}  = object
type ConstantVector* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRConstant::ConstantVector", inheritable.}  = object
type ConstantMatrix* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SPIRConstant::ConstantMatrix", inheritable.}  = object
type Variant* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::Variant", inheritable.}  = object
type Meta* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::Meta", inheritable.}  = object
type Decoration* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::Meta::Decoration", inheritable.}  = object
type ClassicLocale* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::ClassicLocale", inheritable.}  = object
type Resource* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::Resource", inheritable.}  = object
type ShaderResources* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::ShaderResources", inheritable.}  = object
type CombinedImageSampler* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::CombinedImageSampler", inheritable.}  = object
type SpecializationConstant* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::SpecializationConstant", inheritable.}  = object
type BufferRange* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::BufferRange", inheritable.}  = object
...
type Compiler* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::Compiler", inheritable.}  = object
...
type PlsRemap* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::PlsRemap", inheritable.}  = object
type CompilerGLSL* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::CompilerGLSL", inheritable.}  = object
type Options* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::CompilerGLSL::Options", inheritable.}  = object
...
type HLSLVertexAttributeRemap* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::HLSLVertexAttributeRemap", inheritable.}  = object
type CompilerHLSL* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::CompilerHLSL", inheritable.}  = object
type Options00* {.header: "spirv_hlsl.hpp", importcpp:"spirv_cross::CompilerHLSL::Options", inheritable.}  = object
type allocator* {.header: "spirv_hlsl.hpp", importcpp:"std::allocator<char>", inheritable.}  = object
type allocator00* {.header: "spirv_hlsl.hpp", importcpp:"std::allocator<spirv_cross::HLSLVertexAttributeRemap>", inheritable.}  = object
type stdvector_HLSLVertexAttributeRemap* {.header: "spirv_hlsl.hpp", importcpp:"std::vector<HLSLVertexAttributeRemap>", inheritable.}  = object
type allocator0000* {.header: "spirv_hlsl.hpp", importcpp:"std::allocator<unsigned int>", inheritable.}  = object
...
# Procs:
proc vertex*(self: Options): a000000 {.header: "spirv_hlsl.hpp", importcpp: "#.vertex".} #i
proc `vertex=`*(self: Options, value: a000000) {.header: "spirv_hlsl.hpp", importcpp: "#.vertex = #".}
proc fragment*(self: Options): a0000000000 {.header: "spirv_hlsl.hpp", importcpp: "#.fragment".} #i
proc `fragment=`*(self: Options, value: a0000000000) {.header: "spirv_hlsl.hpp", importcpp: "#.fragment = #".}
proc location*(self: HLSLVertexAttributeRemap): uint32 {.header: "spirv_hlsl.hpp", importcpp: "#.location".} #o
proc `location=`*(self: HLSLVertexAttributeRemap, value: uint32) {.header: "spirv_hlsl.hpp", importcpp: "#.location = #".}
proc semantic*(self: HLSLVertexAttributeRemap): astring {.header: "spirv_hlsl.hpp", importcpp: "#.semantic".} #i
proc `semantic=`*(self: HLSLVertexAttributeRemap, value: astring) {.header: "spirv_hlsl.hpp", importcpp: "#.semantic = #".}
proc shadermodel*(self: Options00): uint32 {.header: "spirv_hlsl.hpp", importcpp: "#.shader_model".} #o
proc `shadermodel=`*(self: Options00, value: uint32) {.header: "spirv_hlsl.hpp", importcpp: "#.shader_model = #".}
proc pointsizecompat*(self: Options00): bool {.header: "spirv_hlsl.hpp", importcpp: "#.point_size_compat".} #o
proc `pointsizecompat=`*(self: Options00, value: bool) {.header: "spirv_hlsl.hpp", importcpp: "#.point_size_compat = #".}
proc getoptions*(self: CompilerHLSL): var constType[Options00] {.header: "spirv_hlsl.hpp", importcpp: "const_cast<'0>(#.get_options(@))".}
proc setoptions*(self: CompilerHLSL, opts: var Options00) {.cdecl, exportc, dynlib, header: "spirv_hlsl.hpp", importcpp: "#.set_options(@)".}
proc compile*(self: CompilerHLSL, vertexattributes: stdvector_HLSLVertexAttributeRemap): astring {.header: "spirv_hlsl.hpp", importcpp: "#.compile(@)".}
proc compile*(self: CompilerHLSL): astring {.header: "spirv_hlsl.hpp", importcpp: "#.compile(@)".}
# Lifetime:
...
proc initCompilerHLSL*(spirv: stdvector_uint32t): CompilerHLSL {.importcpp: "spirv_cross::CompilerHLSL(@)".}
...
proc initallocator00*(): allocator00 {.importcpp: "std::allocator<spirv_cross::HLSLVertexAttributeRemap>(@)".}
proc deleteallocator00*(self: ptr allocator00) {.importcpp: "delete #".}
proc initstdvector_HLSLVertexAttributeRemap*(): stdvector_HLSLVertexAttributeRemap {.importcpp: "std::vector<HLSLVertexAttributeRemap>(@)".}
