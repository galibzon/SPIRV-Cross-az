...
type CompilerError* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::CompilerError", inheritable.}  = object
type Instruction* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::Instruction", inheritable.}  = object
type IVariant* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::IVariant", inheritable.}  = object
...
type SPIRUndef* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRUndef", inheritable.}  = object
type SPIRCombinedImageSampler* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRCombinedImageSampler", inheritable.}  = object
type SPIRConstantOp* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRConstantOp", inheritable.}  = object
type SPIRType* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRType", inheritable.}  = object
...
type ImageType* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRType::ImageType", inheritable.}  = object
type ImageType00* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRType::ImageType", inheritable.}  = object
type SPIRExtension* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRExtension", inheritable.}  = object
...
type SPIREntryPoint* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIREntryPoint", inheritable.}  = object
type a* {.nodecl, inheritable.}  = object
type a00* {.nodecl, inheritable.}  = object
type SPIRExpression* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRExpression", inheritable.}  = object
type SPIRFunctionPrototype* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRFunctionPrototype", inheritable.}  = object
type SPIRBlock* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRBlock", inheritable.}  = object
...
type Phi* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRBlock::Phi", inheritable.}  = object
type Case* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRBlock::Case", inheritable.}  = object
type SPIRFunction* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRFunction", inheritable.}  = object
type Parameter* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRFunction::Parameter", inheritable.}  = object
type CombinedImageSamplerParameter* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRFunction::CombinedImageSamplerParameter", inheritable.}  = object
type SPIRAccessChain* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRAccessChain", inheritable.}  = object
type SPIRVariable* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRVariable", inheritable.}  = object
type SPIRConstant* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRConstant", inheritable.}  = object
type Constant* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRConstant::Constant", inheritable.}  = object
type ConstantVector* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRConstant::ConstantVector", inheritable.}  = object
type ConstantMatrix* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SPIRConstant::ConstantMatrix", inheritable.}  = object
type Variant* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::Variant", inheritable.}  = object
type Meta* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::Meta", inheritable.}  = object
type Decoration* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::Meta::Decoration", inheritable.}  = object
type ClassicLocale* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::ClassicLocale", inheritable.}  = object
type Resource* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::Resource", inheritable.}  = object
type ShaderResources* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::ShaderResources", inheritable.}  = object
type CombinedImageSampler* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::CombinedImageSampler", inheritable.}  = object
type SpecializationConstant* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::SpecializationConstant", inheritable.}  = object
type BufferRange* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::BufferRange", inheritable.}  = object
...
type Compiler* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::Compiler", inheritable.}  = object
...
type PlsRemap* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::PlsRemap", inheritable.}  = object
type CompilerGLSL* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::CompilerGLSL", inheritable.}  = object
type Options* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::CompilerGLSL::Options", inheritable.}  = object
...
type CompilerCPP* {.header: "spirv_cpp.hpp", importcpp:"spirv_cross::CompilerCPP", inheritable.}  = object
type allocator* {.header: "spirv_cpp.hpp", importcpp:"std::allocator<char>", inheritable.}  = object
type allocator00* {.header: "spirv_cpp.hpp", importcpp:"std::allocator<unsigned int>", inheritable.}  = object
...
# Procs:
proc compile*(self: CompilerCPP): astring {.header: "spirv_cpp.hpp", importcpp: "#.compile(@)".}
proc setinterfacename*(self: CompilerCPP, name: astring) {.cdecl, exportc, dynlib, header: "spirv_cpp.hpp", importcpp: "#.set_interface_name(@)".}
# Lifetime:
...
proc initCompilerCPP*(spirv: stdvector_uint32t): CompilerCPP {.importcpp: "spirv_cross::CompilerCPP(@)".}
...
proc initallocator00*(): allocator00 {.importcpp: "std::allocator<unsigned int>(@)".}
