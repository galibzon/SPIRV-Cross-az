...
type CompilerError* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::CompilerError", inheritable.}  = object
type Instruction* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::Instruction", inheritable.}  = object
type IVariant* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::IVariant", inheritable.}  = object
...
type SPIRUndef* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRUndef", inheritable.}  = object
type SPIRCombinedImageSampler* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRCombinedImageSampler", inheritable.}  = object
type SPIRConstantOp* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRConstantOp", inheritable.}  = object
type SPIRType* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRType", inheritable.}  = object
...
type ImageType* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRType::ImageType", inheritable.}  = object
type ImageType00* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRType::ImageType", inheritable.}  = object
type SPIRExtension* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRExtension", inheritable.}  = object
...
type SPIREntryPoint* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIREntryPoint", inheritable.}  = object
type a* {.nodecl, inheritable.}  = object
type a00* {.nodecl, inheritable.}  = object
type SPIRExpression* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRExpression", inheritable.}  = object
type SPIRFunctionPrototype* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRFunctionPrototype", inheritable.}  = object
type SPIRBlock* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRBlock", inheritable.}  = object
...
type Phi* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRBlock::Phi", inheritable.}  = object
type Case* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRBlock::Case", inheritable.}  = object
type SPIRFunction* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRFunction", inheritable.}  = object
type Parameter* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRFunction::Parameter", inheritable.}  = object
type CombinedImageSamplerParameter* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRFunction::CombinedImageSamplerParameter", inheritable.}  = object
type SPIRAccessChain* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRAccessChain", inheritable.}  = object
type SPIRVariable* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRVariable", inheritable.}  = object
type SPIRConstant* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRConstant", inheritable.}  = object
type Constant* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRConstant::Constant", inheritable.}  = object
type ConstantVector* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRConstant::ConstantVector", inheritable.}  = object
type ConstantMatrix* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SPIRConstant::ConstantMatrix", inheritable.}  = object
type Variant* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::Variant", inheritable.}  = object
type Meta* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::Meta", inheritable.}  = object
type Decoration* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::Meta::Decoration", inheritable.}  = object
type ClassicLocale* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::ClassicLocale", inheritable.}  = object
type Resource* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::Resource", inheritable.}  = object
type ShaderResources* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::ShaderResources", inheritable.}  = object
type CombinedImageSampler* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::CombinedImageSampler", inheritable.}  = object
type SpecializationConstant* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::SpecializationConstant", inheritable.}  = object
type BufferRange* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::BufferRange", inheritable.}  = object
...
type Compiler* {.header: "spirv_cross.hpp", importcpp:"spirv_cross::Compiler", inheritable.}  = object
type allocator* {.header: "spirv_cross.hpp", importcpp:"std::allocator<char>", inheritable.}  = object
type allocator00* {.header: "spirv_cross.hpp", importcpp:"std::allocator<unsigned int>", inheritable.}  = object
